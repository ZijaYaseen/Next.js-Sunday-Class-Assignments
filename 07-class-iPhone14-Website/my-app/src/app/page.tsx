    ...
    <main>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:w-[720px] w-[375px] md:h-[328px] h-[424px] py-10 px-4 md:p-0">
            {/* Image Section */}
          ...
          {/* 1st box A */}
          <div className="flex flex-col md:flex-row">
            <div className="flex flex-col md:flex-row justify-between items-center md:w-[360px] w-[375px] md:h-[272px] h-[376px] bg-[#EDEDED] py-10 md:p-0">
            ...
            {/*  1st box B */}
            <div className="flex flex-col text-center md:flex-row justify-center items-center md:w-[360px] w-[375px] md:h-[272px] h-[376px] bg-[#353535] py-10 px-4 md:p-0">
              {/* Image Section */}
        ...
        <div className="flex flex-col md:flex-row text-center justify-center items-center md:w-[720px] w-[375px] md:h-[600px] h-[508px] bg-[#EDEDED] py-[42px] px-4 md:p-0">
          <div className="block md:hidden"> {/* Image for mobile */}
